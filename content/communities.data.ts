...
export const TOWNS: Town[] = [
  ...
  },
  {
    ...
    county: "union-county",
    summary:
      "Classic luxury suburb with vibrant downtown and direct Midtown Direct trains.",
    description:
  ...
  },
  {
    ...
    county: "union-county",
    summary:
      "Northeast Corridor rail, diverse housing, and major retail corridors.",
    description:
  ...
  },
  {
    ...
    county: "union-county",
    summary:
      "Sought-after suburb with Gladstone Branch rail and a polished downtown.",
    description:
  ...
  },
  {
    ...
    county: "union-county",
    summary:
      "Neighborhood streets with quick access to Elizabeth, Linden, and major routes.",
    description:
  ...
  },
  {
    ...
    name: "Winfield",
    county: "union-county",
    summary: "Tiny township with close-knit community and affordable housing.",
    description:
  ...
  },
  {
    ...
    summary:
      "Historic town with lively Main Street, Victorian homes, and reservoir views.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Quiet township with rural charm, spacious homes, and natural beauty.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Historic borough with small-town character and affordable housing options.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Quaint borough with walkable downtown, top schools, and direct trains.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Upscale township with estate-style homes, open space, and top schools.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Quaint borough with antique shops, historic character, and rural surroundings.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Expansive rural township with preserved land, farms, and upscale homes.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Known as the 'Hub of Morris County,' with lakes, parks, and strong community.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Historic town with cultural diversity, walkable downtown, and major rail hub.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Historic county seat with lively nightlife, green spaces, and direct rail.",
    description:
  ...
  },
  {
    ...
    summary:
      "University city with cultural venues, rail hub, and redevelopment.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Large township with corporate campuses, varied neighborhoods, and commuter options.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Quaint historic borough with top schools and a charming downtown.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Affluent township with rolling hills, large estates, and preserved land.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Affluent township with strong schools, suburban neighborhoods, and open space.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Expansive township surrounding Morristown with diverse housing and strong schools.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Large township with diverse neighborhoods, shopping, and transit options.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Prestigious lake community with Tudor-style homes and natural beauty.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Family-friendly township with suburban neighborhoods, parks, and strong community.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Large suburban township with top schools, parks, and family amenities.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Small suburban borough with easy access to highways and shopping.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Small historic borough with Main Street charm and suburban living.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Large township with diverse neighborhoods, parks, and shopping centers.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Small urban borough with affordable housing and diverse community.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Expansive rural-suburban township with farms, open space, and top schools.",
    description:
  ...
  },
  {
    ...
    county: "morris-county",
    summary:
      "Historic borough with affordable homes, parks, and highway convenience.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Beloved village with Midtown Direct trains and an artsy, inclusive vibe.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Prestigious commuter town with top-ranked schools, luxury homes, and Midtown Direct trains.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Trendy township with vibrant arts, diverse neighborhoods, and Midtown train service.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Upscale borough with luxury homes, top schools, and suburban tranquility.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Family-friendly township with strong schools, parks, and proximity to NYC.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Small upscale borough with suburban tranquility and strong schools.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Vibrant and diverse village with a lively downtown, Seton Hall University, and direct Midtown trains.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Charming township with Verona Park, strong schools, and a family-oriented lifestyle.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Residential township with strong schools and suburban convenience.",
    description:
  ...
  },
  {
    ...
    county: "essex-county",
    summary:
      "Diverse township with historic sites, suburban neighborhoods, and NYC skyline views.",
    description:
  ...
  },
  {
    ...
    county: "middlesex-county",
    summary:
      "Sprawling suburb with major transit hubs, shopping, and diverse housing.",
    description:
  ...
  },
  {
    ...
    name: "Spotswood",
    county: "middlesex-county",
    summary: "Small suburban borough with strong schools and community feel.",
    description:
