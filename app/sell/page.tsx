  ...
  return (
    <main className="mx-auto max-w-[900px] p-8">
      ...
      <section>
        ...
        <p>
          We benchmark active, pending, and sold comps within micro-markets to
          set an aggressive yet defensible list price.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Light repairs, paint, landscaping, and staging that consistently
          increase perceived value and reduce days on market.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Offer strategy to avoid retrades, manage inspection risk, and protect
          your net.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Highest Buyer Pools: <strong>$900k–$1.2M</strong> (Summit/Chatham),{" "}
            <strong>$1.8M–$2.4M</strong> (Short Hills)
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <details>
          ...
          <p>
            We price to the market’s appetite, not the average. Strategy memo
            provided before list.
          </p>
        </details>
        <details>
