  ...
  return (
    <main className="mx-auto max-w-[900px] p-8">
      ...
      <section>
        ...
        <p>
          We connect you with top lenders for fast, underwritten approvals that
      ...
      <section>
        <h2>Tour Strategy</h2>
        <p>
          Private tours with candid feedback on price, condition, and resale
          risk.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We use escalation clauses <em>only</em> when comps support the
          ceiling. Appraisal gaps are paired with pre-underwritten approvals and
          a defendable LTV. Inspection credits beat price drops in low-inventory
          segments.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          We anticipate hot buttons, pre-wire solutions, and keep your deal on
          track.
        </p>
      </section>
